int NWNXCombat_GetABVersus(object oCreatue = OBJECT_SELF,
                           object oVersus = OBJECT_INVALID);
int NWNXCombat_GetACVersus(object oCreatue = OBJECT_SELF,
                           object oVersus = OBJECT_INVALID);
int NWNXCombat_GetMaxHitPoints(object oCreatue = OBJECT_SELF);
int NWNXCombat_GetSkillRank(int skill, object oCreatue = OBJECT_SELF, 
                            object oVersus = OBJECT_INVALID); 
